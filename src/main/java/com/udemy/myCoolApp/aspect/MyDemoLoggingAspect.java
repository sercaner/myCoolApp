...
public class MyDemoLoggingAspect {
    ...
    @Around("execution(* com.udemy.myCoolApp.service.*.getFortune(..))")
    ...
    @After("execution(* com.udemy.myCoolApp.dao.AccountDAO.findAccounts(..))")
    ...
    @AfterThrowing(
            ...
            pointcut = "execution(* com.udemy.myCoolApp.dao.AccountDAO.findAccounts(..))",
            throwing = "theExc")
